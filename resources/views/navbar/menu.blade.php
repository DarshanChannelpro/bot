...
<div :class="{ 'hidden' : !mobile, 'flex': mobile }"
    ...
    <div
        ...
        <a class="py-3 text-gray-800 hover:text-gray-700 hover:underline" href="/">{{ __('wpbox.features') }}</a>
        <a class="py-3 text-gray-800 hover:text-gray-700 hover:underline" href="/">{{ __('wpbox.pricing') }}</a>
        <a class="py-3 text-gray-800 hover:text-gray-700 hover:underline" href="/">{{ __('wpbox.faq') }}</a>
