...
use App\Http\Controllers\DraggableItemController;
...
Route::get('flow-daigram/{id}/{back_id?}', [DraggableItemController::class, 'index'])->name('flowDaigram');

// Route::get('flow-daigram', function () {
//     return view('boatFLowLayout.dragAndDropFlow');
// })->name('flowDaigram');
...
Route::get('/chatboat', [BoatController::class, 'index'])->name('chatboat');
Route::get('/chatboat/create', [BoatController::class, 'create'])->name('chatboat.create');
Route::post('/chatboat/create', [BoatController::class, 'store'])->name('chatboat.store');
Route::get('/chatboat/{id}/edit', [BoatController::class, 'edit'])->name('chatboat.edit');
Route::post('/chatboat/update', [BoatController::class, 'update'])->name('chatboat.update');
Route::post('/chatboat/{id}/delete', [BoatController::class, 'destroy'])->name('chatboat.delete');
Route::post('/chatboat/bulk-delete', [BoatController::class, 'bulkDelete'])->name('chatboat.bulkDelete');
